...
# 사용법:
#   cd <프로젝트 루트>
#   bash tools/download_inputs.sh          # 받기
#   bash tools/download_inputs.sh --check  # 받지 않고 현황만 출력
#
...
echo
echo "아래는 브라우저로 직접 받아 data/sumstats/ 에 넣어야 하는 것들입니다."
echo "(파일명은 data/sumstats/<key>.tsv.gz 형태로 맞춰주세요)"
echo "----------------------------------------------------------------------"
...
echo "  받은 뒤 data/sumstats/t2d_diagram_v3.txt.gz 로 두세요."
